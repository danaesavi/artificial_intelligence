...
(busqueda)
((= resultado 1) (push nodoFin recorrido)(backtracking candidata closed)(trayectoria recorrido));èxito imprimo recorrido
...
((= (SECOND candidata) nodoFin) (setq resultado 1) resultado) ;termino con èxito
((null (buscaVecinos (SECOND candidata))) (busqueda)) ; no tiene sucesores
(indicaExpande candidata closed)
((= siseExpande 1)(push  candidata closed) (expande candidata (buscaVecinos (SECOND candidata)));checa si no se ha expandido el nodo, 
