...
(setq open nil)
(setq closed nil)
(setq resultado 0 recorrido nil)
;Variables
(setq nameT nil)
;costo
...
(busqueda)
((= resultado 1) (print (calculaCosto candidata) costo1.txt)(push nodoFin recorrido)(backtracking candidata closed)(trayectoria recorrido));èxito imprimo recorrido
((=resultado 0)(setq recorrido 0) (print recorrido out1.txt)) ;fracaso imprimo 0
)
...
(leeEjecutArchivo 3)
(setq nameT (first oD))
(open-output-file out1.txt 'overwrite) (aEstrella (third oD) (second oD)) (close-output-file out1.txt)
...
((null nodos))
(print (car nodos) donde1.txt)
(trayectoriaP (CDR nodos))
)

(defun dondeEstoy(cand)

(open-output-file donde1.txt 'overwrite) (backtrackingP cand closed) (trayectoriaP recorridoP) (close-output-file donde1.txt)
(setq recorridoP nil)
)
...
;(leeEjecutArchivo datos.lsp 11)
;(aEstrella 2 5)
(open-output-file costo1.txt 'overwrite)
(inicio)
...
(close-output-file costo1.txt 'overwrite)
